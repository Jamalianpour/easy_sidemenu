...
class SideMenuFolder  extends StatefulWidget {
  ...
  const SideMenuFolder({
    ...
    this.builder
            ...
            'Title and icon should not be empty at the same time'), super(key: key);
...
class _SideMenuFolderState extends State<SideMenuFolder> {
  ...
  Widget build(BuildContext context) {
    return
      ...
      return (widget.items!=null)?ExpansionTile(
        ...
        leading: _generateIcon(widget.icon, widget.iconWidget),
          ...
          title: (value==SideMenuDisplayMode.open)?Text(widget.foldTitle):Container(),
          children: widget.items!):Container();
    });
  }
